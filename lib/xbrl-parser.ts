...
const METRIC_LABELS: Record<string, string> = {
  ...
  RevenueFromSaleOfProduct: "Revenue from Operations",
  RevenueFromSaleOfServices: "Revenue from Operations",
  InterestEarned: "Revenue from Operations",
  FeesAndCommissionIncome: "Revenue from Operations",
  RentalIncome: "Revenue from Operations",
  ...
  ImpairmentOnFinancialInstruments: "Other Expenses",
  NetLossOnFairValueChanges: "Other Expenses",
  NetLossOnDerecognitionOfFinancialInstrumentsUnderAmortisedCostCategory:
    "Other Expenses",
  FeesAndCommissionExpense: "Other Expenses",
  ...
  ProfitBeforeExceptionalItemsAndTax: "PBT (before exceptional)",
